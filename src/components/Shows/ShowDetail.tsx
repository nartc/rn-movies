import { VideoSite, VideoType, TvShow } from '@api/Models';
...
const ShowDetail: StackScreenComponent<ShowDetailModalScreenProps> = (
  {
    isLoading,
    show,
    id,
               ...
               <View style={ { flex: 1, paddingHorizontal: 10 } }>
                 ...
                 { !!show.production_companies.length && (
                   <MediaDetailSection sectionTitle={ 'Companies' }>
                     <MediaDetailHorizontalList items={ show.production_companies }
                                                imageProp={ 'logo_path' }
                                                height={ 100 }>
                       { item => (
                         <Text style={ { fontSize: 10, textAlign: 'center' } }>{ item.name }</Text>
